...
class Dealers(db.Model):
    ...
    AskForPolicy = db.Column(db.Boolean, nullable=False)
    CategoryID = db.Column(db.Integer, db.ForeignKey('categoria.id'))
    CEAReceived = db.Column(db.Boolean, nullable=False)
    ...
    MandateID = db.Column(db.Integer, db.ForeignKey('mandato.id'))
    ...
    statusID = db.Column(db.Integer, db.ForeignKey('table_status.id'))
    typeID = db.Column(db.Integer, db.ForeignKey('tipo.id'))
